...
export class Volt extends Characteristic {
  static readonly UUID: string = 'E863F10A-079E-48FF-8F27-9C2605A29F52'; // Eve Voltage

  constructor () {
    super('Volt', Volt.UUID, {
      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      // @ts-ignore: custom unit
      unit: 'V',
...
export class Ampere extends Characteristic {
  static readonly UUID: string = 'E863F126-079E-48FF-8F27-9C2605A29F52'; // Eve Ampere

  constructor () {
    super('Ampere', Ampere.UUID, {
      // eslint-disable-next-line @typescript-eslint/ban-ts-comment
      // @ts-ignore: custom unit
      unit: 'A',
      format: Formats.UINT16,
