...
import { SolarEdgeStateAccessory, SolarEdgeACAccessory, SolarEdgeDCAccessory } from './platformAccessory';
  ...
  discoverDevices() {
    ...
    for (const device of exampleDevices) {
      ...
      if (existingAccessory) {
        ...
        if (device.type=="AC")
          new SolarEdgeACAccessory(this, existingAccessory);
        if (device.type=="DC")
          new SolarEdgeDCAccessory(this, existingAccessory);
        ...
        if (device.type=="state")
          ...
          if (device.type=="AC")
          new SolarEdgeACAccessory(this, accessory);
        if (device.type=="DC")
          new SolarEdgeDCAccessory(this, accessory);
